...
def load_templates(script_dir):
    ...
    jpg_dir = os.path.join(script_dir, "jpg18")
    if not os.path.exists(jpg_dir):
        print(f"未找到 jpg18 目录: {jpg_dir}")
        return []
    ...
    while rounds < MAX_ROUNDS:
        ...
        while retry_count < MAX_RETRY_COUNT:
            ...
            if pt and score >= CLICK_THRESHOLD:
                ...
                # ==============================================
                # 新增：第4张图（索引3）点击后 模拟输入 99
                # ==============================================
                if current_index == 3:  # 索引0=1.jpg，1=2.jpg，2=3.jpg，3=4.jpg
                    print("✅ 第4张图点击完成，开始输入键盘：99")
                    # 先激活模拟器窗口，确保键盘输入生效
                    win32gui.SetForegroundWindow(hwnd_outer)
                    time.sleep(0.1)
