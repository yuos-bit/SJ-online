...
def load_templates(script_dir):
    jpg_dir = os.path.join(script_dir, "jpg4")
    if not os.path.exists(jpg_dir):
        print(f"未找到 jpg4 目录: {jpg_dir}")
        return []
    jpg_files = sorted(
...
def main():
    ...
    # 隔5分钟喊话一次
    MESSAGE_TEXT = "/f31/f31/f31紫禁城摆摊，价格好商量/b030/b031/b032/b033/b034/b035/b038/b039/b040/b065/b081/b068/b069/b070/b075/b079"
